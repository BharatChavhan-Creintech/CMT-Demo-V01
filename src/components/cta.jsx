                                ...
                                <div className="grid md:grid-cols-2 grid-cols-1 items-center">
                                    <div className="mt-8">
                                        <div className="section-title text-md-start">
                                            <h6 className="text-white/70 text-sm font-semibold uppercase">Personalized Walkthrough</h6>
                                            <h3 className="font-semibold text-2xl leading-normal text-white mt-2">Get An Easy Start <br/> With CMT Now</h3>
                                        </div>
                                    </div>

                                    <div className="mt-8">
                                        <div className="section-title text-md-start">
                                            <p className="text-white/70 max-w-xl mx-auto mb-2">Receive insights and tips from our experts on how to maximize the efficiency and effectiveness of your compliance efforts.</p>
